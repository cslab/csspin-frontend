...
the csspin-frontend project.

The csspin-frontend repository is hosted on a private GitLab instance, while the
repository itself is mirrored to
[GitHub](https://github.com/cslab/csspin-frontend) for public visibility.
...
Please follow the guidelines below when contributing to the csspin-frontend
project.
...
repository](https://github.com/cslab/csspin-frontend/issues) for reporting issues
...
3. `git clone <your-fork-or-repo-url> csspin-frontend && cd csspin-frontend && pre-commit install`
...
> This section is only relevant for maintainers of the csspin-frontend project.

The version scheme used is major.minor.patch following semver.org.

Releases are created by csspin-frontend maintainers within the GitLab instance hosting
this repository.
...
1. Create the release notes by opening a new merge request at the csspin-frontend
